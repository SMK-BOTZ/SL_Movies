...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001728124509').split()] #Channel id for auto indexing ( make sure bot is admin )
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001690309645') # support group id ( make sure bot is admin )
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/BQRequest') #Support group link ( make sure bot is admin )
